      ...
      <div className="w-full mx-auto mt-8">
        {isInviteLink
          ...
          : <div className="w-full mx-auto">
            ...
            <p className='hidden mt-2 body-md-regular text-text-tertiary'>{t('login.welcome')}</p>
          </div>}
        <div className="bg-white">
          ...
          <div className="hidden w-full block mt-2 system-xs-regular text-text-tertiary">
            {t('login.tosDesc')}
            &nbsp;
            <Link
          ...
          {IS_CE_EDITION && <div className="hidden w-hull block mt-2 system-xs-regular text-text-tertiary">
            {t('login.goToInit')}
            &nbsp;
            <Link
              className='system-xs-medium text-text-secondary hover:underline'
